...
/*
 * The two things the handler drains, described by what it calls on them
 * rather than as http.Server and pg.Pool, so the unit tests can hand in
 * fakes without pretending to be either.
 */
...
/*
 * Everything is injectable for the unit tests; index.ts passes only the real
