 ...
 *
 * Statically imported, the calendar pulled date-fns, react-big-calendar and
 * the datetime picker into the one bundle every visitor downloads before
 * anything paints — libraries only reachable behind sign-in. Split by route,
 * the landing page ships what the landing page renders, and each view's chunk
